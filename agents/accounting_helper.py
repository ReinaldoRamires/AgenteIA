...
class AccountingHelper:
    ...
    def suggest_structure(self, project: models.Project) -> str:
        ...
        """
        console.print(f"🧾 [Accounting Helper] Sugerindo estrutura contábil para: [bold green]{project.name}[/bold green]...")
        ...
        with console.status("[bold yellow]Aguardando IA preparar as recomendações contábeis...[/bold yellow]"):
