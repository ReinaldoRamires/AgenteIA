...
class ProcessMapper:
    ...
    def generate_flowchart(self, project: models.Project, process_name: str) -> str:
        ...
        """
        console.print(f"🌊 [Process Mapper] Mapeando o processo '{process_name}' para: [bold green]{project.name}[/bold green]...")
        ...
        with console.status("[bold yellow]Aguardando IA desenhar o fluxograma...[/bold yellow]"):
