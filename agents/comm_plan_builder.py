...
class CommPlanBuilder:
    ...
    def generate_plan(self, project: models.Project) -> str:
        ...
        """
        console.print(
            f"📡 [Comm Plan Builder] Criando plano de comunicação para: [bold green]{project.name}[/bold green]..."
        )
        ...
        with console.status(
            "[bold yellow]Aguardando IA criar o plano de comunicação...[/bold yellow]"
        ):
