...
class CapacityLeveler:
    ...
    def suggest_actions(self, project: models.Project, capacity_deficit: float) -> str:
        ...
        """
        console.print(f"⚖️  [Capacity Leveler] Sugerindo ações para um déficit de {capacity_deficit:.1f} horas...")
        ...
        with console.status("[bold yellow]Aguardando IA sugerir ações de nivelamento...[/bold yellow]"):
